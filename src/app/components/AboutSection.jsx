...
// We can define the content in a more structured way
    ...
    content: (
      <div className="grid grid-cols-2 sm:grid-cols-3 gap-4">
        {SKILLS_DATA.map((skill, index) => (
          <div key={index} className="bg-[#1e1e24] p-2 rounded text-center text-sm text-[#ADB7BE]">{skill}</div>
        ))}
      </div>
    ),
  },
    ...
    content: (
      <ul className="list-disc pl-2 space-y-2">
        <li>
          ...
          <p className="text-sm text-[#ADB7BE]">{EDUCATION_DATA.Uni}</p>
        </li>
        <li>
          <h3 className="font-bold">Higher Secondary School Certificate (Pre-Engineering)</h3>
          <p className="text-sm text-[#ADB7BE]">{EDUCATION_DATA.college}</p>
        </li>
                <li>
          <h3 className="font-bold">Matriculation (Science Group)</h3>
          <p className="text-sm text-[#ADB7BE]">{EDUCATION_DATA.School}</p>
        </li>
      </ul>
    ),
  },
      ...
      <div className="md:grid md:grid-cols-2 gap-8 items-start py-8 px-4 xl:gap-16 sm:py-16 xl:px-16">
        ...
        <div className="mt-4 md:mt-0 text-left flex flex-col h-full">
          ...
          <p className="text-base lg:text-lg">
           I’m a Computer Science student at the University of Engineering and Technology (UET) Lahore, with a deep interest in creating impactful, future-ready technology.
My journey so far has blended academic learning with hands-on experimentation — allowing me to apply core computer science principles to real-world problems.
<br>
</br>
<br>
</br>
...
<br></br>
        ...
        <div className="mt-8 md:mt-0">
          ...
          <div className="mt-8 p-6 bg-[#18191E] rounded-lg min-h-[200px]">
