      ...
      <h2 className="text-left text-4xl font-bold text-slate-900 dark:text-white mt-4 mb-8 md:mb-12">
        ...
        <div className="text-white space-y-4 mb-6">
          <div className="flex items-center gap-3">
            ...
            <a href="tel: +92 324 4372754" className="hover:text-primary-400">+92 324 4372754</a>
          </div>
          <div className="flex items-center gap-3">
            <EnvelopeIcon className="h-6 w-6 text-primary-500" />
            <a href="mailto:furqan4243@gmail.com" className="hover:text-primary-400">Furqan4243@gmail.com</a>
          </div>
          <div className="flex items-center gap-3">
        ...
        <div className="socials flex flex-row gap-2">
          <Link href="https://github.com/Furqan-10">
            <Image src={GithubIcon} alt="Github Icon" />
          </Link>
          <Link href="https://www.linkedin.com/in/furqan-asif-9438252a6?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app">
